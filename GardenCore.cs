...
namespace OjamajoBot
{
    public static class GardenCore
    {
        ...
        public static string[] weather = { $"☀️", "sunny", "It's a sunny day!","5" };//current weather/initialize it
        public static string[,] arrRandomWeather = {
            {$"☀️", "sunny","A perfect time to water the plant~","5"},
            {$"☁️", "cloudy","There might be a chance to rain soon...","4"},
            {$"🌧️", "raining","Not sure if it's a good time to water the plant.","3"},
            {$"⛈️", "thunder storm","I don't think it's the best time to water the plant now...","2"}
        };
    }
}
